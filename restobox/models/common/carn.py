...
from onnxruntime.transformers.onnx_exporter import load_pretrained_model
from torch.hub import load_state_dict_from_url

__all__ = ["carn", "carn_m"]

from restobox.models.model_utilities import load_pretrained_state
...
class CARN(nn.Module):
    ...
    def load_pretrained(self, map_location=None):
        load_pretrained_state(self, map_location, urls["carn"])
...
class CARNM(nn.Module):
    ...
    def load_pretrained(self, map_location=None):
        load_pretrained_state(self,map_location,urls["carn_m"])
